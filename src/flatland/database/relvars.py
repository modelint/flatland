...
class FlatlandSchema:
    ...
    relvars = {
        'Connector': {
            ...
            'Connector_Name_Specification': Header(attrs=[
                ...
                Attribute(name='Vertical_end_buffer', type='int'),
                Attribute(name='Horizontal_end_buffer', type='int'),
                Attribute(name='Default_name', type='string'),
                Attribute(name='Optional', type='boolean'),
            ], ids={1: ['Connector_type', 'Diagram_type', 'Notation']}),
    ...
    rels = {
        'Connector': [
            ...
            AssocRel(name='R60', assoc_class='Connector_Name_Specification',
                     a_ref=Ref(to_class='Diagram_Notation', mult=mult_tclral['Mc'],
                               from_attrs=['Notation', 'Diagram_type'],
                               to_attrs=['Notation', 'Diagram_type']),
                     b_ref=Ref(to_class='Connector_Type', mult=mult_tclral['Mc'],
                               from_attrs=['Connector_type', 'Diagram_type'],
