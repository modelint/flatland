...
class FlatlandSchema:
    ...
    relvars = {
        'Node': {
            ...
            #     Attribute(name='Margin_top', type='int'),
            #     Attribute(name='Margin_bottom', type='int'),
            #     Attribute(name='Margin_left', type='int'),
            #     Attribute(name='Margin_right', type='int'),
            #     Attribute(name='Color', type='str'),
            #     Attribute(name='Show_margin', type='boolean'),
            # ], ids={1: ['ID']}),
            # 'Column': Header(attrs=[
            #     Attribute(name='ID', type='int'),
            #     Attribute(name='Sheet', type='str'),
            ...
            #     Attribute(name='Show_margin', type='boolean'),
            # ], ids={1: ['ID']}),
            # 'Diagram': Header(attrs=[
            #     Attribute(name='ID', type='int'),
            #     Attribute(name='Grid', type='int'),
            #     Attribute(name='Type', type='str'),
            #     Attribute(name='Notation', type='str'),
            #     Attribute(name='Canvas', type='int'),
            #     Attribute(name='Padding_top', type='int'),
            #     Attribute(name='Padding_bottom', type='int'),
            #     Attribute(name='Padding_left', type='int'),
            #     Attribute(name='Padding_right', type='int'),
            #     Attribute(name='Size_h', type='int'),
            #     Attribute(name='Size_w', type='int'),
            #     Attribute(name='Origin_x', type='int'),
            ...
            # 'Grid': Header(attrs=[
            #     Attribute(name='ID', type='int'),
            #     Attribute(name='Cell_padding_top', type='int'),
            #     Attribute(name='Cell_padding_bottom', type='int'),
            #     Attribute(name='Cell_padding_left', type='int'),
            #     Attribute(name='Cell_padding_right', type='int'),
            #     Attribute(name='Cell_alignment_v', type='str'),
